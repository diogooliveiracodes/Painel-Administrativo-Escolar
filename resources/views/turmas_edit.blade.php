    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card bg-card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('turmas.update', ['turma' => $turma->id]) }}" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control-file" id="codigo" name="codigo" required value='{{$turma->codigo}}'>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="curso_id" class="col-md-4 col-form-label text-md-right">{{ __('Identificador do Curso') }}</label>
                                <div class="col-md-6">
                                    <input type="text" class="form-control-file" id="curso_id" name="curso_id" value="{{$turma->curso_id}}" required>
                                </div>
                            </div>
                        </div>
